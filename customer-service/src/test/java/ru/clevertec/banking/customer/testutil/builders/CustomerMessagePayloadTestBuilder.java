...
@AllArgsConstructor
@NoArgsConstructor
public class CustomerMessagePayloadTestBuilder implements TestBuilder<CustomerMessagePayload> {
    ...
    public CustomerMessagePayload build() {
        return new CustomerMessagePayload(id, customerType, unp, registerDate, email, phoneCode, phoneNumber, customerFullname);
    }
}
