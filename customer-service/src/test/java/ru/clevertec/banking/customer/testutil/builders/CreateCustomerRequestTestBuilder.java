...
@AllArgsConstructor
@NoArgsConstructor
public class CreateCustomerRequestTestBuilder implements TestBuilder<CreateCustomerRequest> {
    ...
    public CreateCustomerRequest build() {
        return new CreateCustomerRequest(id, customerType, unp, registerDate, email, phoneCode, phoneNumber, customerFullname);
    }
}
